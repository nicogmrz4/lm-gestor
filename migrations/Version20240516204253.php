 ...
 */
final class Version20240516204253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE master_league_invitation (id INT AUTO_INCREMENT NOT NULL, master_league_id INT NOT NULL, token VARCHAR(255) NOT NULL, is_used TINYINT(1) NOT NULL, expiration_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_6BDF16E2B306793 (master_league_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_master_league (user_id INT NOT NULL, master_league_id INT NOT NULL, INDEX IDX_21DAC966A76ED395 (user_id), INDEX IDX_21DAC9662B306793 (master_league_id), PRIMARY KEY(user_id, master_league_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', available_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', delivered_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE master_league_invitation ADD CONSTRAINT FK_6BDF16E2B306793 FOREIGN KEY (master_league_id) REFERENCES master_league (id)');
        ...
        $this->addSql('ALTER TABLE user_master_league ADD CONSTRAINT FK_21DAC966A76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_master_league ADD CONSTRAINT FK_21DAC9662B306793 FOREIGN KEY (master_league_id) REFERENCES master_league (id) ON DELETE CASCADE');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE master_league_invitation DROP FOREIGN KEY FK_6BDF16E2B306793');
        ...
        $this->addSql('ALTER TABLE user_master_league DROP FOREIGN KEY FK_21DAC966A76ED395');
        $this->addSql('ALTER TABLE user_master_league DROP FOREIGN KEY FK_21DAC9662B306793');
        $this->addSql('DROP TABLE master_league');
        $this->addSql('DROP TABLE master_league_invitation');
        ...
        $this->addSql('DROP TABLE user_master_league');
