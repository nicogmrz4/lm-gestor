...
final class Version20240506014059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE master_league_player_card_rule (id INT AUTO_INCREMENT NOT NULL, master_league_id INT NOT NULL, card_type VARCHAR(255) NOT NULL, price INT NOT NULL, onece_time TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_402B1ED82B306793 (master_league_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
